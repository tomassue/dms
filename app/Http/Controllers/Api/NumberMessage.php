...
use App\Models\NumberMessage as ModelsNumberMessage;
...
class NumberMessage extends Controller
{
    ...
    public function store($contactNumber)
    {
        ...
        if (!$check_user_contact_number) {
            ...
            if ($contactNumber) {
                try {
                    $sms = new SmsSender();
                    $blaster = new ModelsNumberMessage();
    ...
    {
        $db = ModelsNumberMessage::where('phone_number', $request->phone_number)->where('otp_code', $request->otp)->where('is_verified', 0)->exists();

        if ($db) {
            // The record exists  
            $tot = ModelsNumberMessage::where('phone_number', $request->phone_number)
    ...
    public function verify_otp(Request $content)
    {
        try {
            ...
            $verify = ModelsNumberMessage::where('phone_number', $request->contact_number)
                ->where('otp_code', $request->otp)
     ...
     */
    // public function show(ModelsNumberMessage $ModelsNumberMessage)
    // {
    //     //
    // }
     ...
     */
    public function edit(ModelsNumberMessage $ModelsNumberMessage)
    {
        //
    }
     ...
     */
    public function update(Request $request, ModelsNumberMessage $ModelsNumberMessage)
    {
        //
    }
     ...
     */
    public function destroy(ModelsNumberMessage $ModelsNumberMessage)
    {
        //
    }
}
