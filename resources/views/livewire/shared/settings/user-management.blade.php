                        ...
                        <div class="p-2">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="row py-2 ms-8">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" value="incoming.requests.pdf" id="incomingRequestsPDF" wire:model="permissions" />
                                            <label class="form-check-label" for="incomingRequestsRead"> PDF </label>
                                        </div>
                                    </div>
                                    <div class="row py-2 ms-8">
                                        <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <div class="row py-2 ms-8">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input" type="checkbox" value="incoming.requests.assign" id="incomingRequestsAssign" wire:model="permissions" />
                                            <label class="form-check-label" for="incomingRequestsAssign"> Assign </label>
                                        </div>
                                    </div>
                                    <div class="row py-2 ms-8">
                                        <div class="form-check form-check-custom form-check-solid">
