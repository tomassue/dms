<div>
    <!-- Sidebar -->
    <div id="kt_aside" class="aside bg-primary2" data-kt-drawer="true" data-kt-drawer-name="aside"
            ...
            <div id="kt_aside_menu"
                ...
                @can('dashboard.read')
                    <div class="menu-item py-3">
                        <a class="menu-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }} menu-center"
                            href="{{ route('dashboard') }}" title="Dashboard" data-bs-toggle="tooltip"
                ...
                @canany(['incoming.requests.read', 'incoming.documents.read'])
                    <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                        <span class="menu-link menu-center" title="Incoming" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon me-0">
                        ...
                        <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                            ...
                            @can('incoming.requests.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'incoming-requests' ? 'active' : '' }}"
                                        href="{{ route('incoming-requests') }}">
                            ...
                            @can('incoming.documents.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'incoming-documents' ? 'active' : '' }}"
                                        href="{{ route('incoming-documents') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                @can('outgoing.read')
                    <div class="menu-item py-3">
                        <a class="menu-link menu-center {{ Route::currentRouteName() == 'outgoing' ? 'active' : '' }}"
                            href="{{ route('outgoing') }}" title="Outgoing" data-bs-toggle="tooltip" data-bs-trigger="hover"
                ...
                @can('calendar.read')
                    <div class="menu-item py-3">
                        <a class="menu-link menu-center {{ Route::currentRouteName() == 'calendar' ? 'active' : '' }}"
                            href="{{ route('calendar') }}" title="Calendar" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon me-0">
                ...
                @can('accomplishments.read')
                    <div class="menu-item py-3">
                        <a class="menu-link menu-center {{ Route::currentRouteName() == 'accomplishments' ? 'active' : '' }}"
                            href="{{ route('accomplishments') }}" title="Accomplishments" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon me-0">
                ...
                @can('minutesOfMeeting.read')
                    <div class="menu-item py-3">
                        <a class="menu-link menu-center {{ Route::currentRouteName() == 'meetings' ? 'active' : '' }}"
                            href="{{ route('meetings') }}" title="Meetings" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon me-0">
                ...
                @canany(['reference.accomplishmentCategory.read', 'reference.divisions.read',
                    'reference.incomingDocumentCategory.read', 'reference.incomingRequestCategory.read',
                    'reference.outgoingCategory.read', 'reference.userManagement.read'])
                    <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                        <span class="menu-link menu-center" title="References" data-bs-toggle="tooltip"
                            data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span class="menu-icon me-0">
                        ...
                        <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                            ...
                            @role('Super Admin')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'roles-and-permissions' ? 'active' : '' }}"
                                        href="{{ route('roles-and-permissions') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.userManagement.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'settings.user-management' ? 'active' : '' }}"
                                        href="{{ route('settings.user-management') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.incomingRequestCategory.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'incoming-request-categories' ? 'active' : '' }}"
                                        href="{{ route('incoming-request-categories') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.incomingDocumentCategory.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'incoming-document-categories' ? 'active' : '' }}"
                                        href="{{ route('incoming-document-categories') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.outgoingCategory.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'outgoing-category' ? 'active' : '' }}"
                                        href="{{ route('outgoing-category') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.accomplishmentCategory.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'accomplishment-category' ? 'active' : '' }}"
                                        href="{{ route('accomplishment-category') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.accomplishmentSubCategory.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'accomplishment-sub-category' ? 'active' : '' }}"
                                        href="{{ route('accomplishment-sub-category') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Accomplishment Sub-category</span>
                                    </a>
                                </div>
                            @endcan
                            ...
                            @can('reference.meetingsCategory.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'meetings-category' ? 'active' : '' }}"
                                        href="{{ route('meetings-category') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.divisions.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'settings.divisions' ? 'active' : '' }}"
                                        href="{{ route('settings.divisions') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.position.read')
                                <div class="menu-item" style="display: none;">
                                    <a class="menu-link {{ Route::currentRouteName() == 'settings.positions' ? 'active' : '' }}"
                                        href="{{ route('settings.positions') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('reference.signatories.read')
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'settings.signatories' ? 'active' : '' }}"
                                        href="{{ route('settings.signatories') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
